...
public class OffsetCommitValue implements ApiMessage {
    ...
    public static final Schema SCHEMA_0 =
        new Schema(
            new Field("offset", Type.INT64, "The offset that the consumer wants to store (for this partition)."),
            new Field("metadata", Type.STRING, "Any metadata the client wants to keep."),
            new Field("commit_timestamp", Type.INT64, "The time at which the commit was added to the log.")
        );
    ...
    public static final Schema SCHEMA_1 =
        new Schema(
            ...
            new Field("metadata", Type.STRING, "Any metadata the client wants to keep."),
            new Field("commit_timestamp", Type.INT64, "The time at which the commit was added to the log."),
            new Field("expire_timestamp", Type.INT64, "The time at which the offset will expire.")
        );
    ...
    public static final Schema SCHEMA_3 =
        new Schema(
            new Field("offset", Type.INT64, "The offset that the consumer wants to store (for this partition)."),
            new Field("leader_epoch", Type.INT32, "The leader epoch of the last consumed record."),
            new Field("metadata", Type.STRING, "Any metadata the client wants to keep."),
            new Field("commit_timestamp", Type.INT64, "The time at which the commit was added to the log.")
        );
    ...
    public static final Schema SCHEMA_4 =
        new Schema(
            new Field("offset", Type.INT64, "The offset that the consumer wants to store (for this partition)."),
            new Field("leader_epoch", Type.INT32, "The leader epoch of the last consumed record."),
            new Field("metadata", Type.COMPACT_STRING, "Any metadata the client wants to keep."),
            new Field("commit_timestamp", Type.INT64, "The time at which the commit was added to the log."),
